define(['selfcare', 'angular-mocks'], {
  configure: function(scenarioName) {
    require(["selfcare_test/testHelper", "selfcare_test/scenarios/" + scenarioName + "_scenario"], function(testHelper, scenario) {
      selfcare.ng.application.config(function($provide) {
