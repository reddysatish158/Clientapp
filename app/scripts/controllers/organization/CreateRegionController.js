(function(module) {
  mifosX.controllers = _.extend(module, {
	  CreateRegionController: function(scope, resourceFactory, location, translate, routeParams) {
  ...
  mifosX.ng.application.controller('CreateRegionController', ['$scope', 'ResourceFactory', '$location', '$translate', '$routeParams', mifosX.controllers.CreateRegionController]).run(function($log) {
