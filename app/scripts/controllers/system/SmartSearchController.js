(function(module) {
  mifosX.controllers = _.extend(module, {
	  SmartSearchController: function(scope, resourceFactory , paginatorService,dateFilter) {
  ...
  mifosX.ng.application.controller('SmartSearchController', ['$scope', 'ResourceFactory', 'PaginatorService','dateFilter', mifosX.controllers.SmartSearchController]).run(function($log) {
