(function(module) {
  ...
  mifosX.ng.application.controller('CreateEventValidationController', ['$scope', 'ResourceFactory', '$location', mifosX.controllers.CreateEventValidationController]).run(function($log) {
