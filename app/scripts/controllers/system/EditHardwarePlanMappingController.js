(function(module) {
  ...
  mifosX.ng.application.controller('EditHardwarePlanMappingController', ['$scope', 'ResourceFactory', '$location', '$routeParams', mifosX.controllers.EditHardwarePlanMappingController]).run(function($log) {
