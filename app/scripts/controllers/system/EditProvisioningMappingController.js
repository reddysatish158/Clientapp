(function(module) {
	  ...
	  mifosX.ng.application.controller('EditProvisioningMappingController', ['$scope', '$routeParams', 'ResourceFactory', '$location', mifosX.controllers.EditProvisioningMappingController]).run(function($log) {
