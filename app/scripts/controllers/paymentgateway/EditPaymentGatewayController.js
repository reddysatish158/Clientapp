(function(module) {
  ...
  mifosX.ng.application.controller('EditPaymentGatewayController', ['$scope', '$routeParams', 'ResourceFactory', '$location', mifosX.controllers.EditPaymentGatewayController]).run(function($log) {
